...
../.tools/node/bin/npm run verify:visitor-auth
../.tools/node/bin/npm run verify:dual-entrypoints
```
...
../.tools/node/bin/npm run verify:admin-login
../.tools/node/bin/npm run verify:admin-api-auth
```
